...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QLabel, QHBoxLayout, QVBoxLayout, QMessageBox,QRadioButton, QGroupBox, QButtonGroup
...
q2 = Question("Государственный язык Бразилии", "Португальский", "Французский", "Английский", "Испанский")
q3 = Question("Какое государство старше", "Египет", "Рим", "Англия", "Франция")
q4 = Question("У какой страны больше территория", "Россия", "Китай", "США", "Канада")
...
def show_result():
    radiobox.hide()
    resultbox.show()
    submit.setText("Следующий вопрос")
...
resultbox.hide()
mainVline.addWidget(submit, alignment=Qt.AlignCenter)
